...
namespace NCloud.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<CloudUser> _signInManager;
        private readonly UserManager<CloudUser> _userManager;
        private readonly IUserStore<CloudUser> _userStore;
        private readonly IUserEmailStore<CloudUser> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<CloudUser> userManager,
            IUserStore<CloudUser> userStore,
        ...
        private IUserEmailStore<CloudUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<CloudUser>)_userStore;
        }
    }
}
