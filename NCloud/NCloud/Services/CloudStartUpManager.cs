...
namespace NCloud.Services
{
    ...
    /// </summary>
    public static class CloudStartUpManager
    {
        ...
        public static void Initialize(IServiceProvider serviceProvider, ILogger loggerService)
        {
            ...
            {
                adminUser = new CloudUser { FullName = Constants.AdminUserName, UserName = Constants.AdminUserName, Email = config.GetSection("EmailCredentials:Email").Get<string>()!, EmailConfirmed = true, MaxSpace = (double)SpaceSizes.GB5 };
